...
function language_strings() {
	...
	arr["RUSSIAN",659]="${pending_of_translation} Ошибка. Недействительные функции \"${normal_color}${current_function}${red_color}\" в плагине \"${normal_color}${plugin}${red_color}\". Функция пытается изменить не существует. Исправьте это, прежде чем продолжить"

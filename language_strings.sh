...
function language_strings() {
	...
	arr["GREEK",324]="${pending_of_translation} Το αρχείο καταγραφής δημιουργήθηκε επιτυχώς στο [${normal_color}${et_handshake}${blue_color}]"
	arr["ITALIAN",324]="${pending_of_translation} File di cattura generato con successo in [${normal_color}${et_handshake}${blue_color}]"
	...
	arr["GERMAN",324]="${pending_of_translation} Erfassen-Datei wurde erfolgreich in generiert [${normal_color}${et_handshake}${blue_color}]"
	arr["TURKISH",324]="${pending_of_translation} Yakalama dosyası başarıyla oluşturuldu [${normal_color}${et_handshake}${blue_color}]"
	...
	arr["GREEK",683]="${pending_of_translation} Έχει επιβεβαιωθεί ότι το αρχείο καταγραφής περιέχει το Handshake/PMKID του δικτύου προορισμού. Το script μπορεί να συνεχίσει... "
	arr["ITALIAN",683]="${pending_of_translation} Il file Capture è stato verificato per contenere Handshake/PMKID della rete di destinazione. Lo script può continuare..."
	...
	arr["GERMAN",683]="${pending_of_translation} Es wurde überprüft, ob die Erfassungsdatei Handshake/PMKID des Zielnetzwerks enthält. Das Skript kann fortfahren..."
	arr["TURKISH",683]="${pending_of_translation} Yakalama dosyasının hedef ağın El Handshake/PMKID değerini içerdiği doğrulandı. Yazılım devam edebilir..."

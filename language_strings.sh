...
function language_strings() {
	...
	arr["ITALIAN",632]="Inserisci la localitá locale (Hong Kong, Dublin):"
	...
	arr["ITALIAN",636]="C'è un errore nella tua configurazione. Per favore controlla il file ${rc_file}. Hai attivato l'opzione per forzare l'uso di mdk3 (${normal_color}AIRGEDDON_MDK_VERSION${red_color}) ma il tuo sistema non ha mdk3 installato. Disabilita questa opzione o installa mdk3 per risolvere il problema"

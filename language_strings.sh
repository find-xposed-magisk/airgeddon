...
function language_strings() {
	...
	arr["PORTUGUESE",630]="${pending_of_translation} Digite o código do país de duas letras (EUA, ES, FR):"
	arr["RUSSIAN",630]="${pending_of_translation} Введите двухбуквенный код страны (США, ES, FR):"
	arr["GREEK",630]="${pending_of_translation} Εισαγάγετε τον κωδικό χώρας δύο χαρακτήρων (ΗΠΑ, ES, FR):"
	arr["ITALIAN",630]="${pending_of_translation} Inserisci il codice paese di due lettere (USA, ES, FR):"
	arr["POLISH",630]="${pending_of_translation} Wpisz dwuliterowy kod kraju (USA, ES, FR):"
	arr["GERMAN",630]="${pending_of_translation} Geben Sie den zweistelligen Ländercode ein (US, ES, FR):"
	arr["TURKISH",630]="${pending_of_translation} İki harfli ülke kodunu girin (ABD, ES, FR):"
	...
	arr["CATALAN",631]="${pending_of_translation} Introduïu l’estat o la província (Madrid, Nova Jersey):"
	arr["PORTUGUESE",631]="${pending_of_translation} Digite o estado ou a província (Madri, Nova Jersey):"
	arr["RUSSIAN",631]="${pending_of_translation} Введите штат или провинцию (Мадрид, Нью-Джерси):"
	arr["GREEK",631]="${pending_of_translation} Πληκτρολογήστε κράτος ή επαρχία (Μαδρίτη, Νιου Τζέρσεϋ):"
	arr["ITALIAN",631]="${pending_of_translation} Entra nello stato o provincia (Madrid, New Jersey):"
	arr["POLISH",631]="${pending_of_translation} Wpisz stan lub prowincję (Madryt, New Jersey):"
	...
	arr["CATALAN",632]="${pending_of_translation} Introduïu el locale (Hong Kong, Dublín):"
	arr["PORTUGUESE",632]="${pending_of_translation} Digite a localidade (Hong Kong, Dublin):"
	arr["RUSSIAN",632]="${pending_of_translation} Введите язык (Гонконг, Дублин):"
	arr["GREEK",632]="${pending_of_translation} Εισάγετε locale (Χονγκ Κονγκ, Δουβλίνο):"
	arr["ITALIAN",632]="${pending_of_translation} Inserisci locale (Hong Kong, Dublino):"
	...
	arr["CATALAN",635]="${pending_of_translation} Introduïu \"nom comú\" (CN) per cert (ecorp.com):"
	arr["PORTUGUESE",635]="${pending_of_translation} Digite \"nome comum\" (CN) para cert (ecorp.com):"
	arr["RUSSIAN",635]="${pending_of_translation} Введите \"общее имя\" (CN) для сертификата (ecorp.com):"
	arr["GREEK",635]="${pending_of_translation} Πληκτρολογήστε \"κοινό όνομα\" (CN) για cert (ecorp.com):"
	arr["ITALIAN",635]="${pending_of_translation} Inserisci \"nome comune\" (CN) per cert (ecorp.com):"
	arr["POLISH",635]="${pending_of_translation} Wpisz \"nazwę zwyczajową\" (CN) dla cert (ecorp.com):"
	arr["GERMAN",635]="${pending_of_translation} Geben Sie für cert (ecorp.com) \"common name\" (CN) ein:"
	arr["TURKISH",635]="${pending_of_translation} Sertifika için \"ortak ad\" (CN) girin (ecorp.com):"

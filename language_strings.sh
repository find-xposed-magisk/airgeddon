...
function language_strings() {
	...
	arr["ENGLISH",652]="Certificates are invalid or outdated, so the attack can't be performed"
	arr["SPANISH",652]="Los certificados no son válidos o están caducados, por lo que el ataque no se puede realizar"
	arr["FRENCH",652]="${pending_of_translation} Les certificats ne sont pas valides ou ont expiré. L'attaque ne peut donc pas être effectuée"
	arr["CATALAN",652]="${pending_of_translation} Els certificats no són vàlids o estan caducats, de manera que l'atac no es pot realitzar"
	arr["PORTUGUESE",652]="${pending_of_translation} Os certificados são inválidos ou expiraram, portanto, o ataque não pode ser executado"
	arr["RUSSIAN",652]="${pending_of_translation} Сертификаты недействительны или устарели, поэтому атака не может быть выполнена"
	arr["GREEK",652]="${pending_of_translation} Τα πιστοποιητικά είναι άκυρα ή ξεπερασμένα, οπότε η επίθεση δεν μπορεί να εκτελεστεί"
	arr["ITALIAN",652]="${pending_of_translation} I certificati non sono validi o scaduti, quindi l'attacco non può essere eseguito"
	arr["POLISH",652]="${pending_of_translation} Certyfikaty są nieprawidłowe lub nieaktualne, więc nie można wykonać ataku"
	arr["GERMAN",652]="${pending_of_translation} Zertifikate sind ungültig oder veraltet, sodass der Angriff nicht ausgeführt werden kann"
	arr["TURKISH",652]="${pending_of_translation} Sertifikalar geçersiz veya eski, bu nedenle saldırı gerçekleştirilemiyor"
	...
	arr["ENGLISH",655]="Private key is invalid or the password is wrong, so the attack can't be performed"
	arr["SPANISH",655]="La clave privada no es válida o la contraseña es errónea, por lo que el ataque no se puede realizar"
	arr["FRENCH",655]="${pending_of_translation} La clé privée n'est pas valide ou le mot de passe est incorrect. L'attaque ne peut donc pas être effectuée"
	arr["CATALAN",655]="${pending_of_translation} La clau privada no és vàlida o la contrasenya és errònia, de manera que l'atac no es pot realitzar"
	arr["PORTUGUESE",655]="${pending_of_translation} A chave privada não é válida ou a senha está errada, então o ataque não pode ser executado"
	arr["RUSSIAN",655]="${pending_of_translation} Закрытый ключ неверен или пароль неверен, поэтому атака не может быть выполнена"
	arr["GREEK",655]="${pending_of_translation} Το ιδιωτικό κλειδί δεν είναι έγκυρο ή ο κωδικός πρόσβασης είναι λάθος, επομένως η επίθεση δεν μπορεί να εκτελεστεί"
	arr["ITALIAN",655]="${pending_of_translation} La chiave privata non è valida o la password è errata, quindi l'attacco non può essere eseguito"
	arr["POLISH",655]="${pending_of_translation} Klucz prywatny jest nieprawidłowy lub hasło jest nieprawidłowe, więc nie można wykonać ataku"
	arr["GERMAN",655]="${pending_of_translation} Der private Schlüssel ist ungültig oder das Passwort ist falsch, sodass der Angriff nicht ausgeführt werden kann"
	arr["TURKISH",655]="${pending_of_translation} Özel anahtar geçersiz veya şifre yanlış, bu nedenle saldırı gerçekleştirilemiyor"

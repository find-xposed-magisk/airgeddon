...
function language_strings() {
	...
	reboot_required["CATALAN"]="${pending_of_translation} ${red_color_slim} (reinici requerit)${normal_color}"
	reboot_required["PORTUGUESE"]="${pending_of_translation} ${red_color_slim} (é necessário reiniciar)${normal_color}"
	reboot_required["RUSSIAN"]="${pending_of_translation} ${red_color_slim} (требуется перезагрузка)${normal_color}"
	reboot_required["GREEK"]="${pending_of_translation} ${red_color_slim} (απαιτείται επανεκκίνηση)${normal_color}"
	reboot_required["ITALIAN"]="${pending_of_translation} ${red_color_slim} (riavvio richiesto)${normal_color}"
	...
	arr["CATALAN",618]="${pending_of_translation} Maneig de finestres actual: ${pink_color}xterm${normal_color}${reboot_required_text}"
	arr["PORTUGUESE",618]="${pending_of_translation} Gerenciador de janelas atual: ${pink_color}xterm${normal_color}${reboot_required_text}"
	arr["RUSSIAN",618]="${pending_of_translation} Текущее управление окнами: ${pink_color}xterm${normal_color}${reboot_required_text}"
	arr["GREEK",618]="${pending_of_translation} Τρέχουσα Διαχείριση παραθύρων: ${pink_color}xterm${normal_color}${reboot_required_text}"
	arr["ITALIAN",618]="${pending_of_translation} Gestione delle finestre attuale: ${pink_color}xterm${normal_color}${reboot_required_text}"
	...
	arr["CATALAN",619]="${pending_of_translation} Maneig de finestres actual: ${pink_color}tmux${normal_color}${reboot_required_text}"
	arr["PORTUGUESE",619]="${pending_of_translation} Gerenciador de janelas atual: ${pink_color}tmux${normal_color}${reboot_required_text}"
	arr["RUSSIAN",619]="${pending_of_translation} Текущее управление окнами: ${pink_color}tmux${normal_color}${reboot_required_text}"
	arr["GREEK",619]="${pending_of_translation} Τρέχουσα Διαχείριση παραθύρων: ${pink_color}tmux${normal_color}${reboot_required_text}"
	...
	arr["CATALAN",620]="${pending_of_translation} S'ha modificat l'opció en el fitxer de configuració. Reinicia el script perquè els canvis tinguin efecte"
	arr["PORTUGUESE",620]="${pending_of_translation} Ele mudou a opção no arquivo de configuração. Reinicie o script para que as alterações entrem em vigor"
	...
	arr["GREEK",620]="${pending_of_translation} Άλλαξε την επιλογή στο αρχείο ρυθμίσεων. Ξεκινήστε πάλι το σενάριο για τις αλλαγές να τεθούν σε ισχύ"
	arr["ITALIAN",620]="${pending_of_translation} Ha cambiato l'opzione nel file di configurazione. Riavviare lo script per le modifiche abbiano effetto"
	...
	arr["CATALAN",651]="${pending_of_translation} 12. Deshabilitar sistema de plugins permanentment"
	arr["PORTUGUESE",651]="${pending_of_translation} 12. Desativar permanentemente sistema de plugins"
	arr["RUSSIAN",651]="${pending_of_translation} 12. Отключить систему плагинов навсегда"
	arr["GREEK",651]="${pending_of_translation} 12. Απενεργοποιήστε μόνιμα το σύστημα προσθηκών"
	...
	arr["CATALAN",652]="${pending_of_translation} 12. Habilitar sistema de plugins permanentment"
	arr["PORTUGUESE",652]="${pending_of_translation} 12. Ativar sistema de plugins permanentemente"
	arr["RUSSIAN",652]="${pending_of_translation} 12. Включить систему плагинов постоянно"
	arr["GREEK",652]="${pending_of_translation} 12. Ενεργοποίηση συστήματος plugin μόνιμα"
	...
	arr["CATALAN",653]="${pending_of_translation} Sistema de plugins: ${pink_color}Activat${normal_color}${reboot_required_text}"
	arr["PORTUGUESE",653]="${pending_of_translation} Sistema de plugins: ${pink_color}Ativo${normal_color}${reboot_required_text}"
	arr["RUSSIAN",653]="${pending_of_translation} Система плагинов: ${pink_color}Включено${normal_color}${reboot_required_text}"
	arr["GREEK",653]="${pending_of_translation} Σύστημα Πρόσθετα: ${pink_color}Ενεργοποιημένη${normal_color}${reboot_required_text}"
	...
	arr["CATALAN",654]="${pending_of_translation} Sistema de plugins: ${pink_color}Desactivat${normal_color}${reboot_required_text}"
	arr["PORTUGUESE",654]="${pending_of_translation} Sistema de plugins: ${pink_color}Desativo${normal_color}${reboot_required_text}"
	arr["RUSSIAN",654]="${pending_of_translation} Система плагинов: ${pink_color}Отключено${normal_color}${reboot_required_text}"
	arr["GREEK",654]="${pending_of_translation} Σύστημα Πρόσθετα: ${pink_color}Απενεργοποιημένη${normal_color}${reboot_required_text}"
	arr["ITALIAN",654]="${pending_of_translation} Sistema di plugin: ${pink_color}Disattivato${normal_color}${reboot_required_text}"
	...
	arr["CATALAN",655]="${pending_of_translation} ${blue_color}Es va a desactivar el sistema de plugins. ${green_color}¿Vols continuar? ${normal_color}${visual_choice}"
	arr["PORTUGUESE",655]="${pending_of_translation} ${blue_color}O sistema de plug-in será desativado. ${green_color}Você deseja continuar? ${normal_color}${visual_choice}"
	...
	arr["GREEK",655]="${pending_of_translation} ${blue_color}Το σύστημα plugin θα απενεργοποιηθεί. ${green_color}Θέλετε να συνεχίσετε; ${normal_color}${visual_choice}"
	...
	arr["CATALAN",656]="${pending_of_translation} ${blue_color}Es va a habilitar el sistema de plugins. ${green_color}¿Vols continuar? ${normal_color}${visual_choice}"
	arr["PORTUGUESE",656]="${pending_of_translation} ${blue_color}O sistema de plug-in será ativado. ${green_color}Você deseja continuar? ${normal_color}${visual_choice}"
	...
	arr["GREEK",656]="${pending_of_translation} ${blue_color}Το σύστημα plugin θα είναι ενεργοποιημένο. ${green_color}Θέλετε να συνεχίσετε; ${normal_color}${visual_choice}"
	...
	arr["CATALAN",657]="${pending_of_translation} ${blue_color}Es va a habilitar tmux. ${green_color}¿Vols continuar? ${normal_color}${visual_choice}"
	arr["PORTUGUESE",657]="${pending_of_translation} ${blue_color}Isso habilitará tmux. ${green_color}Você deseja continuar? ${normal_color}${visual_choice}"
	...
	arr["GREEK",657]="${pending_of_translation} ${blue_color}tmux πρόκειται να ενεργοποιηθεί. ${green_color}Θέλετε να συνεχίσετε; ${normal_color}${visual_choice}"
	...
	arr["CATALAN",658]="${pending_of_translation} ${blue_color}Es va a habilitar xterm. ${green_color}¿Vols continuar? ${normal_color}${visual_choice}"
	arr["PORTUGUESE",658]="${pending_of_translation} ${blue_color}Isso habilitará xterm. ${green_color}Você deseja continuar? ${normal_color}${visual_choice}"
	...
	arr["GREEK",658]="${pending_of_translation} ${blue_color}xterm πρόκειται να ενεργοποιηθεί. ${green_color}Θέλετε να συνεχίσετε; ${normal_color}${visual_choice}"
	...
	arr["CATALAN",659]="${pending_of_translation} Error. Funció no vàlida \"${current_function}\" al connector \"${plugin}\". La funció que s'intenta modificar no existeix. Arregla-ho abans de continuar"
	arr["PORTUGUESE",659]="${pending_of_translation} Error. Inválidos de função \"${current_function}\" no plugin \"${plugin}\". A função tenta modificar não existe. Corrija-o antes de continuar"
	...
	arr["GREEK",659]="${pending_of_translation} Σφάλμα. Μη έγκυρη λειτουργία \"${current_function}\" στο πρόγραμμα \"${plugin}\". Η λειτουργία επιχειρεί να τροποποιήσει δεν υπάρχει. Διορθώστε το πριν συνεχίσετε"

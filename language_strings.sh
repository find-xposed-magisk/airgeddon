...
function language_strings() {
	...
	arr["ENGLISH",653]="Plugins system: ${pink_color}Enabled${normal_color}"
	arr["SPANISH",653]="Sistema de plugins: ${pink_color}Activado${normal_color}"
	arr["FRENCH",653]="${pending_of_translation} Système de plugins: ${pink_color}Activé${normal_color}"
	arr["CATALAN",653]="${pending_of_translation} Sistema de plugins: ${pink_color}Activat${normal_color}"
	arr["PORTUGUESE",653]="${pending_of_translation} Sistema de plugins: ${pink_color}Ativo${normal_color}"
	arr["RUSSIAN",653]="${pending_of_translation} Система плагинов: ${pink_color}Включено${normal_color}"
	arr["GREEK",653]="${pending_of_translation} Σύστημα Πρόσθετα: ${pink_color}Ενεργοποιημένη${normal_color}"
	arr["ITALIAN",653]="${pending_of_translation} Sistema di plugin: ${pink_color}Attivato${normal_color}"
	arr["POLISH",653]="${pending_of_translation} System wtyczek: ${pink_color}Włączone${normal_color}"
	arr["GERMAN",653]="${pending_of_translation} Plugins-System: ${pink_color}Aktiviert${normal_color}"
	arr["TURKISH",653]="${pending_of_translation} Eklentiler sistemi: ${pink_color}Aktif${normal_color}"

	arr["ENGLISH",654]="Plugins system: ${pink_color}Disabled${normal_color}"
	arr["SPANISH",654]="Sistema de plugins: ${pink_color}Desactivados${normal_color}"
	arr["FRENCH",654]="${pending_of_translation} Système de plugins: ${pink_color}Désactivé${normal_color}"
	arr["CATALAN",654]="${pending_of_translation} Sistema de plugins: ${pink_color}Desactivat${normal_color}"
	arr["PORTUGUESE",654]="${pending_of_translation} Sistema de plugins: ${pink_color}Desativo${normal_color}"
	arr["RUSSIAN",654]="${pending_of_translation} Система плагинов: ${pink_color}Отключено${normal_color}"
	arr["GREEK",654]="${pending_of_translation} Σύστημα Πρόσθετα: ${pink_color}Απενεργοποιημένη${normal_color}"
	arr["ITALIAN",654]="${pending_of_translation} Sistema di plugin: ${pink_color}Disattivato${normal_color}"
	arr["POLISH",654]="${pending_of_translation} System wtyczek: ${pink_color}Wyłączone${normal_color}"
	arr["GERMAN",654]="${pending_of_translation} Plugins-System: ${pink_color}Deaktiviert${normal_color}"
	arr["TURKISH",654]="${pending_of_translation} Eklentiler sistemi: ${pink_color}DevreDışı${normal_color}"
